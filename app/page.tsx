...
export default async function Page() {
  ...
  return <Dashboard initial={{ user: { email: user.email ?? '' }, workspaces, numbers: [], members: [], error: error ? 'Workspace data could not be loaded. Please check the database setup.' : undefined }}/>;
}
